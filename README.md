...
4️⃣ Revenue vs Profit (Scatter Plot)
...
6️⃣ Assets vs Market Value (Scatter Plot)
...
# Project Structure
India-Largest-Companies/
│── web_scraping_india_companies.ipynb
│── README.md
